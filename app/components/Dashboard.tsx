  ...
  return <main>
    ...
    <section className="hero">
      <div>
        ...
        <p className="sub">Kartu confluence berdiri sendiri dan tidak memfilter eksperimen ranking. <Link href="/ranking">Lihat eksperimen ranking terpisah →</Link> · <Link href="/reverse">Reverse replay (paper only) →</Link> · <Link href="/original">Original replay →</Link></p>
      </div>
